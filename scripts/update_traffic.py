...
FREE_FLOW_SPEED = 50
CONSTRAINED_FLOW_SPEED = 50
PREDICTED_SPEED = 8 # Simulate congestions in predicted traffic
...
if not mapping:
    raise SystemExit(f"ERROR: OSM way {osm_way_id} not found in {way_edges_path}")
