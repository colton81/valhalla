...
function(get_source_path PATH NAME)
  if(NAME STREQUAL "valhalla_encode_flexpolyline" OR NAME STREQUAL "valhalla_decode_flexpolyline")
    set(${PATH} ${VALHALLA_SOURCE_DIR}/src/flexpolyline/flexpolyline.cc PARENT_SCOPE)
  elseif(EXISTS ${VALHALLA_SOURCE_DIR}/src/${NAME}.cc)
